...
_WEIGHT_DECAY = 5e-4
_PRE_TRAINED_MODEL = './resnet_v2_101/resnet_v2_101.ckpt'

# TODO: Tem q tentar entender as camadas e também como fazer o output igual a Unet.

def deeplab_v3_plus_generator(num_classes = 2, output_stride = 8, base_architecture = 'resnet_v2_101', pre_trained_model = '', batch_norm_decay = None, data_format='channels_last'):
  ...
  def model(inputs, is_training):
    ...
    # TODO: output of deep lab bottle neck here
    ...
    # return predictions,logits,encoder_output
    return logits
